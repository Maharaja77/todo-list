...
function App() {
     ...
     function onChangeHandler(id,key,value){
          setUsers(()=>{return users.map(user=>{
        ...
        <table className='bp4-html-table modifier'>
          ...
          <tbody>
               ...
               <tr key={user.id}>
                    <td>{user.id}</td>
                    <td>{user.name}</td>
                    <td><EditableText onChange={value=>onChangeHandler(user.id,'website',value)}value={user.email}/></td>
                    <td><EditableText value={user.website}/></td>
                    <td><Button intent='success'onClick={()=>updateUser(user.id)}>update</Button>
